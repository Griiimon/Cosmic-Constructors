...
func _integrate_forces(state: PhysicsDirectBodyState3D) -> void:
	...
	match axis:
		Axis.X:
			local_ang_vel= Vector3(0, local_ang_vel.y, local_ang_vel.z)
		Axis.Y:
			local_ang_vel= Vector3(local_ang_vel.x, 0, local_ang_vel.z)
		Axis.Z:
			local_ang_vel= Vector3(local_ang_vel.x, local_ang_vel.y, 0)
